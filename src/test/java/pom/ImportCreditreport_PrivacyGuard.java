...
public class ImportCreditreport_PrivacyGuard extends login
{
	public ImportCreditreport_PrivacyGuard(WebDriver driver) {
		super(driver);
	}
	...
	@FindBy(xpath = "//li[.='PrivacyGuard ']")
	public WebElement PrivacyGuard;
	...
	public void importPrivacyGuard(String data) throws InterruptedException
	{
		...
		elementvisibility(PrivacyGuard);
		Assert.assertTrue(PrivacyGuard.isEnabled(), "PrivacyGuard provider not exists");
		System.out.println("PrivacyGuard provider exists");
		PrivacyGuard.click();
